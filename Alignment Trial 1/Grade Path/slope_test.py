...
#        oxsl=ppd.argsort()
        srd.insert(ppd,point)
        srn.insert(nei[xsl],point)
        sru.insert(True,point)

pickle.dump([srd.map, srn.map, sru.map], open("C:\\Users\\SANJEEV BASHYAL\\Documents\\QGIS\\Grade Path\\srd_srn_sru_20.dat", "wb"))
